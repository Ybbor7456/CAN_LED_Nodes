...
constexpr unsigned ID_NODE2 = 0x311;   // Pi #2 (not this one either)
constexpr unsigned ID_NODE3 = 0x312; 	//  PI #3 (this) 
...
void setup() {
  ...
  CAN.init_Filt(0, 0, ID_NODE3);
  CAN.init_Filt(1, 0, ID_NODE3);

  CAN.init_Mask(1, 0, 0x7FF);
  CAN.init_Filt(2, 0, ID_NODE3);
  CAN.init_Filt(3, 0, ID_NODE3);
  CAN.init_Filt(4, 0, ID_NODE3);
  CAN.init_Filt(5, 0, ID_NODE3);
